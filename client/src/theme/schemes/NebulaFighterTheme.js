...
const colors = {
  ...
  layout: {
    ...
    sidebar: {
      ...
      menuItemBgActive: '#5bc0de',
      menuItemIconColor: 'white',
...
export const NebulaFighterTheme = createTheme({
  ...
  sidebar: {
    ...
    boxShadow: '1px 0 0 #1E1E1E',
    width: '280px'
  },
  header: {
    height: '88px',
    background: themeColors.primaryAlt,
    boxShadow: '0px 1px 0px #1E1E1E',
  ...
  components: {
    MuiBackdrop: {
      styleOverrides: {
        root: {
          backgroundColor: alpha(darken('#121212', 0.5), 0.4),
